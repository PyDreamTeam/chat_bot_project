# Generated by Django 4.1.5 on 2023-09-21 13:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='save', max_length=800, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('image', models.TextField(blank=True, null=True)),
                ...
                ('filter', models.ManyToManyField(null=True, to='platforms.platformtag')),
            ],
        ),
    ]

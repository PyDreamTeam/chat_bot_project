    ...
    def post(self, request):
        ...
        if refresh_token:
            try:
                ...
                return Response({'error': 'Невозможно выйти из системы. Пожалуйста, попробуйте еще раз.'}, status=400)
        else:
            return Response({'error': 'Пожалуйста, предоставьте токен обновления.'}, status=400)
